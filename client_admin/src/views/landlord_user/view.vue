		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="民宿名称" prop="name_of_homestay">
												<el-input id="name_of_homestay" v-model="form_sub['name_of_homestay']" placeholder="请输入民宿名称"
							  v-if="user_group === '管理员' || (form_sub['landlord_user_id'] && $check_field('set','name_of_homestay')) || (!form_sub['landlord_user_id'] && $check_field('add','name_of_homestay'))"></el-input>
					<div v-else-if="$check_field('get','name_of_homestay')">{{form_sub['name_of_homestay']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','landlord_name') || $check_field('add','landlord_name') || $check_field('set','landlord_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="房东姓名" prop="landlord_name">
												<el-input id="landlord_name" v-model="form_sub['landlord_name']" placeholder="请输入房东姓名"
							  v-if="user_group === '管理员' || (form_sub['landlord_user_id'] && $check_field('set','landlord_name')) || (!form_sub['landlord_user_id'] && $check_field('add','landlord_name'))"></el-input>
					<div v-else-if="$check_field('get','landlord_name')">{{form_sub['landlord_name']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="民宿地址" prop="homestay_address">
												<el-input id="homestay_address" v-model="form_sub['homestay_address']" placeholder="请输入民宿地址"
							  v-if="user_group === '管理员' || (form_sub['landlord_user_id'] && $check_field('set','homestay_address')) || (!form_sub['landlord_user_id'] && $check_field('add','homestay_address'))"></el-input>
					<div v-else-if="$check_field('get','homestay_address')">{{form_sub['homestay_address']}}</div>
											</el-form-item>
			</el-col>
			...
			return {
				...
				disabledObj:{
								"name_of_homestay_isDisabled": false,
										"landlord_name_isDisabled": false,
