		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','id_number')" min-width="200">
					...
					<el-table-column prop="number_of_check_in_days" @sort-change="$sortChange" label="入住天数"
				v-if="user_group == '管理员' || $check_field('get','number_of_check_in_days')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/order_management/table','set') || $check_action('/order_management/view','set') || $check_action('/order_management/view','get') || $check_action('/退订/table','add') || $check_action('/退订/view','add')" >
