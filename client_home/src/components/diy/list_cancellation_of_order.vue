		...
		<view class="cancellation_of_order_block box_wrap" >
			<navigator class="item_cancellation_of_order box_style" v-for="(o, i) in list"  :key="i" :url="'/pages/cancellation_of_order/details?cancellation_of_order_id=' + o['cancellation_of_order_id']">
					...
					<view class="title" v-if="true">
						...
						<view class="view" v-if="1 && $check_index_field('get','name_of_homestay','/cancellation_of_order/list')">
					<view class="title" v-if="true">
						<span>民宿名称</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="1 && $check_index_field('get','room_number','/cancellation_of_order/list')">
					<view class="title" v-if="true">
						<span>房间号</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="1 && $check_index_field('get','room_type','/cancellation_of_order/list')">
					<view class="title" v-if="true">
						<span>房间房型</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="1 && $check_index_field('get','check_in_price','/cancellation_of_order/list')">
					<view class="title" v-if="true">
						<span>入住价格</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','booking_users','/cancellation_of_order/list')">
					<view class="title" v-if="true">
						<span>预订用户</span>
					</view>
					...
					<view class="title" v-if="true">
						...
						<view class="view" v-if="0 && $check_index_field('get','reason_for_unsubscription','/cancellation_of_order/list')">
					<view class="title" v-if="true">
						<span>退订原因</span>
					</view>
							<view class="diy_field text" >
						<span>{{ o["reason_for_unsubscription"] }}</span>
					</view>
						</view>
