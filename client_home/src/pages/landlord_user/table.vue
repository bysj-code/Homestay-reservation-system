<template>
  <view class="page_landlord_user diy_table diy_table_tml" id="landlord_user_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/landlord_user/view?" v-show="user_group == '管理员' || $check_action('/landlord_user/table','add') || $check_action('/landlord_user/view','add')">添加</navigator>
                            ...
                            <span>民宿名称</span>
								...
								<text>
									{{ o["name_of_homestay"] }}
													...
													<view v-if="1 && $check_field('get','landlord_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>房东姓名</span>
                          </view>
								...
								<text>
									{{ o["landlord_name"] }}
													...
													<view v-if="0 && $check_field('get','homestay_address')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>民宿地址</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/landlord_user/table','del') || $check_action('/landlord_user/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/landlord_user/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/landlord_user/table','set') || $check_action('/landlord_user/view','set') || $check_action('/landlord_user/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
