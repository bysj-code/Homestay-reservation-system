          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','name_of_homestay') || ($check_field('add','name_of_homestay') || $check_field('set','name_of_homestay'))" label="民宿名称" name="name_of_homestay">
                            <uni-easyinput type="text" v-model="form['name_of_homestay']" v-if="user_group === '管理员' || (form['landlord_user_id'] && $check_field('set','name_of_homestay')) || (!form['landlord_user_id'] && $check_field('add','name_of_homestay'))" :disabled="disabledObj['name_of_homestay_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','name_of_homestay')">
                  {{ form['name_of_homestay'] }}
                </text>
                          </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','landlord_name') || ($check_field('add','landlord_name') || $check_field('set','landlord_name'))" label="房东姓名" name="landlord_name">
                            <uni-easyinput type="text" v-model="form['landlord_name']" v-if="user_group === '管理员' || (form['landlord_user_id'] && $check_field('set','landlord_name')) || (!form['landlord_user_id'] && $check_field('add','landlord_name'))" :disabled="disabledObj['landlord_name_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','landlord_name')">
                  {{ form['landlord_name'] }}
                </text>
                          </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','homestay_address') || ($check_field('add','homestay_address') || $check_field('set','homestay_address'))" label="民宿地址" name="homestay_address">
                            <uni-easyinput type="text" v-model="form['homestay_address']" v-if="user_group === '管理员' || (form['landlord_user_id'] && $check_field('set','homestay_address')) || (!form['landlord_user_id'] && $check_field('add','homestay_address'))" :disabled="disabledObj['homestay_address_isDisabled']" />
                <!-- 仅查看 -->
...
export default {
  ...
  data() {
    return {
      ...
      url_add: "~/api/landlord_user/add?",
      url_set: "~/api/landlord_user/set?",
      url_get_obj: "~/api/landlord_user/get_obj?",
      url_upload: "~/api/landlord_user/upload?",
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/landlord_user/upload?'),
