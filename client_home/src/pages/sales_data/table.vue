<template>
  <view class="page_sales_data diy_table diy_table_tml" id="sales_data_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/sales_data/view?" v-show="user_group == '管理员' || $check_action('/sales_data/table','add') || $check_action('/sales_data/view','add')">添加</navigator>
                            ...
                            <span>报表日期</span>
								...
								<text>
									{{ $toTime(o["report_date"],"yyyy-MM-dd") }}
													...
													<view v-if="0 && $check_field('get','sales_volumes')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>销售数量</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/sales_data/table','del') || $check_action('/sales_data/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/sales_data/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/sales_data/table','set') || $check_action('/sales_data/view','set') || $check_action('/sales_data/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
